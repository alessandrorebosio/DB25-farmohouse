...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}X|c|c|}
    ...
    \hline
    1 & \hyperref[op1]{Visualizzazione statistiche dashboard} & 50 & Admin / Staff \\
    \hline
    2 & \hyperref[op2]{Verifica disponibilità camere} & 300 & Tutti \\
    \hline
    3 & \hyperref[op3]{Verifica disponibilità tavoli} & 250 & Tutti \\
    \hline
    4 & \hyperref[op4]{Inserimento recensione evento} & 20 & Cliente \\
    \hline
    5 & \hyperref[op5]{Inserimento recensione servizio} & 30 & Cliente \\
    \hline
    6 & \hyperref[op6]{Aggiornamento recensione} & 10 & Cliente \\
    \hline
    7 & \hyperref[op7]{Update e Iscrizione utente a evento} & 25 & Cliente \\
    \hline
    8 & \hyperref[op8]{Creazione prenotazione principale} & 100 & Cliente / Staff \\
    \hline
    9 & \hyperref[op9]{Prenotazione tavolo ristorante} & 80 & Cliente / Staff \\
    \hline
    10 & \hyperref[op10]{Prenotazione camera con controllo duplicati} & 70 & Cliente / Staff \\
    \hline
    11 & \hyperref[op11]{Eliminazione prenotazione servizio} & 20 & Cliente / Staff \\
    \hline
    12 & \hyperref[op12]{Eliminazione iscrizione evento} & 15 & Cliente \\
    \hline
    13 & \hyperref[op13]{Eliminazione prenotazione con controllo temporale} & 15 & Cliente / Staff \\
    \hline
    14 & \hyperref[op14]{Verifica credenziali di login} & 500 & Tutti \\
    \hline
    15 & \hyperref[op15]{Creazione nuovo ordine} & 60 & Cliente / Staff \\
    \hline
  \end{tabularx}
...
\begin{enumerate}
    \item {\large \textbf{Visualizzazione statistiche dashboard}} \label{op1}
    
    Operazione complessa che recupera multiple statistiche per la dashboard amministrativa.
    ...
    Totale: $A_{lett} = 100 + 20 + 30 + 12000 + 500 + 45000 + 150 + 2500 + 5000 + 50 + 15000 + 8000 = 88350$
    
    $$\mathbf{C_{tot}} = 50 \cdot 88350 = \mathbf{4.417.500}$$

    \item {\large \textbf{Verifica disponibilità camere}} \label{op2}
    ...
    Si leggono tutte le camere e si verificano le prenotazioni esistenti.
    
    Totale: $A_{lett} = 30 + 30 + 1200 = 1260$
    $$\mathbf{C_{tot}} = 300 \cdot 1260 = \mathbf{378.000}$$

    \item {\large \textbf{Verifica disponibilità tavoli}} \label{op3}
    ...
    \item {\large \textbf{Inserimento recensione evento}} \label{op4}
    ...
    \item {\large \textbf{Inserimento recensione servizio}} \label{op5}
    ...
    \item {\large \textbf{Aggiornamento recensione}} \label{op6}
    ...
    \item {\large \textbf{Update e Iscrizione utente a evento}} \label{op7}
    ...
    \item {\large \textbf{Creazione prenotazione principale}} \label{op8}
    ...
    \item {\large \textbf{Prenotazione tavolo ristorante}} \label{op9}
    ...
    \item {\large \textbf{Prenotazione camera con controllo duplicati}} \label{op10}
    ...
    \item {\large \textbf{Eliminazione prenotazione servizio}} \label{op11}
    ...
    \item {\large \textbf{Eliminazione iscrizione evento}} \label{op12}
    ...
    \item {\large \textbf{Eliminazione prenotazione con controllo temporale}} \label{op13}
    ...
    \item {\large \textbf{Verifica credenziali di login}} \label{op14}
    ...
    \item {\large \textbf{Creazione nuovo ordine}} \label{op15}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}X|c|c|}
        ...
        \hline
        Visualizzazione statistiche dashboard & 4.417.500 & Admin / Staff \\
        \hline
